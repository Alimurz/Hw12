// const mas = [
//     {Numbers:3, some: "duckduckie"},
//     { title: "Утка", text: "утка утки" },
//     {Number:1, something: "dakjldam"}
//   ];
...
// 2) Дан элемент. Сделайте так, чтобы по клику на него он красился в красный цвет, но только если в момент клика нажата клавиша Ctrl
    ...
    // const alcohol = document.getElementsByTagName("p");
    //     for (let i = 0; i < alcohol.length; i++) {
    //         alcohol[i].addEventListener("click", showSquare);
    //     }
